...
- [x] Download music and video from YT
- [ ] Others
...
npm start
```
> *If this appeared **(Y/I/N/O/D/Z) [default=N] ?** use the letter **"y"** and then **"ENTER"** to continue with the installation.*
</details>
...
``` 
#### Available Options
> *This will delete all history you have established with PM2:*
```bash 
pm2 delete index
``` 
> *If you have closed Termux and want to see the execution again use:*
```bash 
pm2 logs 
``` 
...
> ✔️ Make sure your Cloud Shell has Node.js installed.

> Credits to **[Dioneibi-rip](https://github.com/Dioneibi-rip)**
