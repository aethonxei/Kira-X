...
let handler = async (m, { conn, text, usedPrefix, command }) => {
  if (!text) return m.reply(`${emoji} Please enter the name of an NPMJs package and version (optional).`);
  ...
  try {
    ...
    m.reply('It looks like an error occurred or the package was not found.');
  }
};
