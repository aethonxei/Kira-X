...
var handler = async (m, { conn, args, participants }) => {
  ...
  if (m.mentionedJid.length === 2) {
    ...
    return conn.reply(m.chat, `❤️ Mention one or two people to ship them.\n\nExample:\n.ship @user1 @user2`, m);
  }
  ...
  let loveMessage = `
💖 *Love compatibility between ${name1} y ${name2}* 💖
❤️ *Result:* ${lovePercent}%
💌 *Potential partner:* ${name1} 💞 ${name2}
`.trim();
