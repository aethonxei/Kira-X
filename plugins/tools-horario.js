...
const handler = async (m, {conn}) => {
  const fechamor = moment().tz('Africa/Casablanca').format('DD/MM HH:mm');
  ...
  await conn.sendMessage(m.chat, {text: `「 TIME ZONES ⏰ 」
⏱️Morocco    : ${fechamor}
⏱️Peru       : ${fechaper}
⏱️Mexico     : ${fechamex}
⏱️Bolivia    : ${fechabol}
...
handler.help = ['time'];
handler.tags = ['info'];
handler.command = ['time', 'tz', 'timezones']
