...
if (!text) return conn.reply(m.chat, `${emoji} Please enter the APK name to download it.`, m)
try {
await m.react(rwait)
conn.reply(m.chat, `${emoji} Downloading your app, please wait a moment...`, m)
...
return conn.reply(m.chat, `${msm} A failure occurred...`, m)}}
