...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} You won 🥳, You get +4999 XP` : isTie ? 'The game ended in a draw. 😐' : `Shift @${room.game.currentTurn.split('@')[0]}`}
`.trim();
