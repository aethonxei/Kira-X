...
if (!text) { return conn.reply(m.chat, `${emoji} Please enter the text of what you want to search for on Twitter.`, m); }

await message.react(rwait)
conn.reply(message.chat, `${emoji} Downloading your video, please wait a moment..` message)
...
let txt =  `👤 *User:* ${res.user}\n`
    txt += `📅 *Publication:* ${res.post}\n`
    txt += `☁️ *Profile:* ${res.profile}\n`
