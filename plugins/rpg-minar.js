...
let handler = async (m, { conn }) => {
  ...
  if (now - user.lastmiming < tiempoMinar) {
    ...
    return conn.reply(m.chat, `⛏️ You're still recovering from the last mine..\n⏳ Wait *${restante}* to mine again.`, m)
  }
  ...
  const eventosBuenos = [
    {
      texto: '✨ You found a giant vein of emeralds!',
      cambios: () => ({
        exp: r(250, 500),
        coin: r(3000, 6000),
        emerald: r(5, 10),
    ...
    {
      texto: '💰 You opened an abandoned chest full of resources!',
      cambios: () => ({
        exp: r(300, 700),
        coin: r(5000, 2999),
        emerald: r(2, 6),
    ...
    {
      texto: '💎 You discovered a secret cave with ancient riches!',
      cambios: () => ({
        exp: r(500, 900),
        coin: r(10000, 20000),
        emerald: r(10, 20),
    ...
    {
      texto: '🔨 Your blows were precise and you extracted many minerals!',
      cambios: () => ({
        exp: r(100, 300),
        coin: r(1000, 3000),
        emerald: r(1, 3),
    ...
    {
      texto: '🍀 Today was your lucky day, you found a rare mineral!',
      cambios: () => ({
        exp: r(300, 600),
        coin: r(6000, 10000),
        emerald: r(4, 8),
  ...
  const eventosMalos = [
    {
      texto: '💥 There was an explosion inside the mine!',
      cambios: () => ({
        exp: r(50, 100),
        coin: -r(1000, 2000),
        emerald: -r(1, 2),
    ...
    {
      texto: '🥵 You got lost and found almost nothing useful.',
      cambios: () => ({
        exp: r(30, 70),
        coin: -r(500, 1500),
        emerald: 0,
    ...
    {
      texto: '📉 A landslide blocked the road and you lost part of the loot..',
      cambios: () => ({
        exp: r(70, 120),
        coin: -r(2000, 2000),
        emerald: -r(2, 4),
  ...
  resultado =
    ...
    `♦️ *Emerald:* ${formato(cambios.emerald)}\n` +
    `🔩 *Iron:* ${formato(cambios.iron)}\n` +
    `🏅 *Gold:* ${formato(cambios.gold)}\n` +
    `🕋 *Coal:* ${formato(cambios.coal)}\n` +
    `🪨 *Stone:* ${formato(cambios.stone)}`
...
handler.command = ['mn', 'miming', 'mine']
