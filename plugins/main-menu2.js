...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  ...
  try {
    const pp = 'https://files.catbox.moe/gegwez.jpg';
...
*IT IS NOT NECESSARY TO USE A PREFIX IN AUDIO*
∘ _Noche de paz_
∘ _Basta jovenes ya_
∘ _chambie_
∘ _Buenos dias_
...
∘ _Gol!_`.trim();     
    ...
    conn.reply(m.chat, '*This menu has an internal error, which is why it could not be sent..*', m);
  }
};
handler.tags = ['main']
handler.help = ['menu2']
