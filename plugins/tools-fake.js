...
if (!text) return m.reply(`${emoji} *Example of use*\n\n!${command} Hello @${m.sender.split`@`[0]} Zb`, null, { mentions: [m.sender] })
let cm = copy(m)
let who
...
if (!who) return m.reply(`${emoji} *Example of use*\n\n!${command}* Hello @${m.sender.split`@`[0]} T7wa`, null, { mentions: [m.sender] })
cm.key.fromMe = false
