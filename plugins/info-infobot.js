...
*▸ Commands Used:* ${totalStats.toLocaleString('en-US')}
*▸ Activity:* ${formatUptime(uptime)}

---
*🖥️ SERVER (HOST)*
*▸ Platform:* ${osPlatform}
*▸ Host:* ${osHostname}
*▸ CPU:* ${cpuModel} (${cpuCores} nuclei)
*▸ RAM (Used):* ${format(ramUsed)}
*▸ RAM (Total):* ${format(ramTotal)}

---
*⚙️ MEMORY USAGE (Node.js)*
\`\`\`
...
`.trim();
    ...
    const imageUrl = 'https://files.catbox.moe/9wlmu9.jpg';
